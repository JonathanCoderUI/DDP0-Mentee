...
def starburst_animation(x_target, y_target):
    ...
    panjang_percikan = ... # TODO: Memilih integer acak dalam interval [50, 150]
    jumlah_percikan = ... # TODO: Memilih integer acak dalam interval [15, 30]
    warna = DAFTAR_WARNA[...] # TODO: Mengambil warna dengan memilih indeks acak dalam interval [0, 5]
    sudut = ... # TODO: Hitung sudut antar percikan (360 derajat dibagi jumlah percikan)
...
def draw_firework():
    x_target = ... # TODO: Memilih integer acak dalam interval [-250, 250]
    y_target = ... # TODO: Memilih integer acak dalam interval [50, 200]
